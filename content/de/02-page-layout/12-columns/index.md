...
Wer jemals eine Physikzeitschrift aufgeschlagen hat, hat das zweispaltige Layout bemerkt. Es ist
das universelle Signal für "Dies ist extrem komplizierte und ernsthafte Forschung." Unsere
...
der Hauptteil zwei Spalten verwendet. Das gelingt, indem du die Spalteneinstellung nach dem
Abstract platzierst:
...
Mache den Hauptteil des Papers zweispaltig, während Titel und Abstract über die volle Breite
gehen. Füge `#set page(columns: 2)` direkt nach dem Abstract-Absatz, aber vor der Einleitung ein.
...
> [!TIP] Wenn die Vorschau beengt wirkt, versuche die Ränder leicht zu reduzieren (z.B. `1.5cm`),
> um den Spalten mehr Platz zu geben. Akademische Paper sind dicht, aber sie sollten nicht
