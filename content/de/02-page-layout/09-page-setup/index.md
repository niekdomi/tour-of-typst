...
tatsächlich annehmen. Typst lässt dich Seitengrösse und Ränder mit `#set`-Regeln am Anfang deines
Dokuments konfigurieren.
...
Beobachte die Vorschau. Der Text sollte in eine seriöse Blocksatzdarstellung einrasten. Dr. Crumb
hat gedroht, uns den Laborzugang zu entziehen, wenn sie noch einmal einen Flattersatz sieht, also
ist das entscheidend.

> [!NOTE] `#set`-Regeln gelten für alles, was nach ihnen kommt.
