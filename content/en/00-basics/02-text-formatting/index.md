...
A scientific abstract without emphasis is like toast without butter, technically functional, but
missing the point. Typst uses simple markers to make text bold or italic:
...
Write the abstract for our paper. The key findings need to stand out so that even a sleep-deprived
peer reviewer will notice them:
