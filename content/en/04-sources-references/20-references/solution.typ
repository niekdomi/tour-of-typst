...
perception or pessimism. It is a consequence of _angular momentum_,
_gravitational acceleration_, and the unfortunate geometry of breakfast items.
This paper derives a model for toast rotation and validates it experimentally.
