...
page size and margins with `#set` rules at the top of your document.
...
Watch the preview, the text should snap into justified respectability. Dr. Crumb has threatened to
revoke our lab access if she sees one more ragged-right margin, so this is crucial.

> [!NOTE] `#set` rules apply to everything that comes after them.
