...
> [!NOTE] `#set page(columns: 2)` changes the page layout, which forces a **page break**. Everything
> after it starts on a new page. Scroll down in the preview to see it. This is expected. Typst can't
> change the column count mid-page.
